    ...
    export default {
        ...
        methods: {
            fetchUser () {
                ...
                this.$http({url: '/api/user/' + itemId, method: 'GET'}).then(function (response) {
                    this.$set('user', response.data)
                })
            },
            updateUser (user) {
                event.preventDefault();
                this.$http.patch('/api/user/' + user.hashid, user).then(function (response) {
                    show_stack_success('User saved', response)
                }, function (response){
                    show_stack_error('Failed to save user', response)
                })
            },
            deleteUser (user) {
                event.preventDefault();
